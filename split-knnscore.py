...
def split():
    ...
    data1 = readcsv2list('data/knnscore_data_seperate_test/train/train_all.csv')
    ...
    for i in range(10):
        ...
        # if i < 9:           
        split10fold(data1[i * 171:i * 171 + 171], data1[1710 + i * 171:1710 + i * 171 + 171], 'data/knnscore_data_seperate_test/train/part_{}'.format(i))
